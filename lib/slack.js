...
async function removeReaction(token, channel, timestamp, emoji) {
...
module.exports = { verifySlackSignature, postMessage, postReply, getBotUserId, getThreadReplies, addReaction, removeReaction };
