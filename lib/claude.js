...
const tools = [
  ...
  {
    name: "wise_balances",
    description: "Get all Wise account balances (per currency).",
    input_schema: { type: "object", properties: {} },
  },
  {
    name: "wise_transactions",
    description: "Get recent Wise transactions. Can filter by currency.",
    input_schema: {
      type: "object",
      properties: {
...
const toolHandlers = {
  ...
  wise_balances: () => getBalances(),
  wise_transactions: (input) => getTransactions({ currency: input.currency, limit: input.limit }),
